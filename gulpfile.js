...
gulp.task("copy-deps:angularcss", function () {
    return gulp.src(paths.npmSrc + '/@angular/**/*.css', { base: paths.npmSrc + '/@angular/' })
        .pipe(gulp.dest(paths.npmLibs + '/@angular/'));
});


gulp.task("copy-deps:jquery", function () {
    return gulp.src(paths.npmSrc + '/jquery/dist/**/*.js', { base: paths.npmSrc + '/jquery/' })
